            ...
            <div className="flex flex-col items-center text-center md:relative md:pr-8 mb-6 md:mb-0">
              ...
              <div className="flex flex-wrap justify-center gap-3">
                {[
                  ...
                  const buttonContent = (
                    <div
                      className={`w-8 h-8 flex items-center justify-center transition ${iconHover} cursor-pointer`}
            ...
            <div className="py-6 grid gap-3 md:gap-1 md:grid-cols-4 md:items-center items-start">
              <div className="flex flex-col items-center text-center md:relative md:pr-8 mb-4 md:mb-0">
                ...
                <div className="flex flex-wrap justify-center gap-3">
                  ...
                  <CVPopup>
                    <div className="w-8 h-8 border border-black bg-white flex items-center justify-center text-[8px] font-black cursor-pointer" aria-label="CV">
                      CV
                    </div>
                  </CVPopup>
                </div>
