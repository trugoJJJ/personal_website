          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6" style={{ color: isDark ? P("white") : P("charcoal") }}>
              ...
              <p className="text-base md:text-lg">
                Pomagam firmom B2B, usługowym oraz produktowym w budowaniu skutecznej komunikacji marketingowej. Łączę działania kreatywne z umiejętnościami strategicznymi w planowaniu, prowadzeniu i analizowaniu kampanii.</p>
              <p className="text-base md:text-lg">
                ...
                return (
                  <div className="grid grid-cols-1 md:grid-cols-5 gap-8 items-center">
                    ...
                    <div className="hidden md:block col-span-2 justify-self-end text-center">
                      ...
                      >
                        <img src={QR_DATA_URI} alt="QR Code - linktr.ee/trugojjj" className="w-[90%] h-[90%] object-contain" />
                      </a>
                    </div>
                  </div>
                );
