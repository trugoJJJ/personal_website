          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6" style={{ color: isDark ? P("white") : P("charcoal") }}>
              ...
              <p className="text-base md:text-lg">
                Pomagam firmom B2B i usługowym w budowaniu skutecznej komunikacji marketingowej. Łączę działania kreatywne z umiejętnościami strategicznymi w planowaniu, prowadzeniu i analizowaniu kampanii.</p>
              <p className="text-base md:text-lg">
