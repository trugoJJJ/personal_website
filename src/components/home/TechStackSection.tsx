...
const TechStackSectionContent = () => {
  ...
  const techStack = [
    { category: "AI Tools", items: [{ name: "ChatGPT", url: "https://chat.openai.com" }, { name: "Gemini", url: "https://gemini.google.com" }, { name: "Cursor AI", url: "https://cursor.sh" }, { name: "Napkin AI", url: "https://napkin.ai" }, { name: "N8N", url: "https://n8n.io" }, { name: "Claude Code", url: "https://claude.com/claude-code" }] },
    ...
    { category: "Dane & Infrastruktura", items: [{ name: "Apify", url: "https://apify.com" }, { name: "Bright Data", url: "https://brightdata.com" }, { name: "SerpApi", url: "https://serpapi.com" }, { name: "Stripe", url: "https://stripe.com" }, { name: "Railway", url: "https://railway.app" }] },
    ...
    { category: "Analityka", items: [{ name: "Google Analytics", url: "https://marketingplatform.google.com/about/analytics/" }, { name: "Google Tag Manager", url: "https://tagmanager.google.com" }, { name: "Hotjar", url: "https://hotjar.com" }, { name: "Mixpanel", url: "https://mixpanel.com" }, { name: "Data Studio", url: "https://lookerstudio.google.com/" }, { name: "PostHog", url: "https://posthog.com" }, { name: "Grafana", url: "https://grafana.com" }] },
    ...
    { category: "SEO & Search", items: [{ name: "Google Search Console", url: "https://search.google.com/search-console" }, { name: "Screaming Frog", url: "https://www.screamingfrog.co.uk/seo-spider/" }, { name: "Ahrefs", url: "https://ahrefs.com" }, { name: "SEMRush", url: "https://semrush.com" }, { name: "Senuto", url: "https://senuto.com" }, { name: "Nodeshub", url: "https://nodeshub.com" }] },
    ...
    { category: "Zarządzanie projektami", items: [{ name: "Notion", url: "https://notion.so" }, { name: "Asana", url: "https://asana.com" }, { name: "Monday.com", url: "https://monday.com" }, { name: "Trello", url: "https://trello.com" }, { name: "Slack", url: "https://slack.com" }, { name: "ClickUp", url: "https://clickup.com" }] },
    ...
    <ClientOnlyWrapper fallback={
      <section className="py-24 md:py-36 bg-[#FAF6EE] border-t-3 border-black" id="techstack">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              "AI Tools", "Design & Grafika", "Animacja & Video", "Dane & Infrastruktura", "No-Code & Prototyping", "Analityka",
