...
const TechStackSectionContent = () => {
  ...
  const techStack = [
    ...
    { category: "Programowanie", items: [{ name: "HTML", url: "https://developer.mozilla.org/en-US/docs/Web/HTML" }, { name: "CSS", url: "https://developer.mozilla.org/en-US/docs/Web/CSS" }, { name: "Python", url: "https://www.python.org" }, { name: "GitHub", url: "https://github.com" }, { name: "VSCode/Cursor", url: "https://cursor.sh" }, { name: "Vercel/CyberFolks", url: "https://vercel.com" }] },
    ...
    { category: "Zarządzanie projektami", items: [{ name: "Notion", url: "https://notion.so" }, { name: "Asana", url: "https://asana.com" }, { name: "Trello", url: "https://trello.com" }, { name: "Slack", url: "https://slack.com" }, { name: "HubSpot CRM", url: "https://hubspot.com" }, { name: "Pipedrive", url: "https://pipedrive.com" }, { name: "SALESmanago", url: "https://salesmanago.com" }] },
    ...
    <ClientOnlyWrapper fallback={
      <section className="py-24 md:py-36 bg-[#FAF6EE] border-t-3 border-black" id="techstack">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              "AI Tools", "Design & Grafika", "Animacja & Video", "Programowanie", "No-code/Low-code", "Analityka",
              "Social Media & PPC", "Email Marketing", "Zarządzanie projektami", "Komunikacja", "SEO"
            ].map((category) => (
