...
const ExperienceSectionContent = () => {
  ...
  const certs = [
    { year: "2023", title: "Podstawy marketingu cyfrowego", org: "Google", url: "https://skillshop.exceedlms.com/student/collection/796504-digital-marketing", image: "/google_certfikat.png" },
